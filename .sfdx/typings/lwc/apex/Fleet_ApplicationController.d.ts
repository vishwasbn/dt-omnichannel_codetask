...
declare module "@salesforce/apex/Fleet_ApplicationController.sendEmailController" {
  export default function sendEmailController(param: {appID: any, accountId: any}): Promise<any>;
}
declare module "@salesforce/apex/Fleet_ApplicationController.getARApplicationStatus" {
  export default function getARApplicationStatus(param: {arAppId: any}): Promise<any>;
}
